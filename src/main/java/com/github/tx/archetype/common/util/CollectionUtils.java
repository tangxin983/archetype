package com.github.tx.archetype.common.util;
...
public class CollectionUtils extends
	 ...
	 * @return List
	 */
	public static <T> List<T> extractToList(Collection collection,
			String propertyName) {
	 ...
	 */
	public static <T> List<T> extractToList(Collection collection,
			String propertyName, boolean ignoreEmptyValue) {
		if (collection == null) {
			return null;
		}
	...
	public static <T> Set<T> extractToSet(Collection collection,
			String propertyName, boolean ignoreEmptyValue) {
		if (collection == null) {
			return null;
		}
