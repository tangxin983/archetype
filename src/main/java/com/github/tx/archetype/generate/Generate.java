package com.github.tx.archetype.generate;
...
import com.github.tx.archetype.common.util.FileUtils;
import com.github.tx.archetype.common.util.FreeMarkers;
import com.github.tx.archetype.common.util.TimeUtils;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		model.put("classAuthor", StringUtils.isNotBlank(author) ? author
				: "Generate Tools");
		model.put("classVersion", TimeUtils.getCurrentDate());
